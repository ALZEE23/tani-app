...
<head>
  ...
  <title>Jendela Tani: Login</title>
  ...
  <div class="content-area">
    ...
    <div class="container login-area">
      <div class="section">
        ...
        <div class="row center">
          <button type="submit" class="waves-effect waves-light btn-large bg-secondary">Login</button>
          <div class="spacer"></div>
          <div class="links">

            <a href="ui-pages-forgotpassword.html">Forgot Password</a><span class="sep">|</span><a href="{{ route('register') }}">Register</a>
          </div>
