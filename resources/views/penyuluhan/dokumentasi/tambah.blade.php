...
<div class="container has-pagehead is-pagetitle">
    <div class="section">
        <h5 class="pagetitle">Tambah Dokumentasi Kegiatan</h5>
    </div>
</div>
<div class="container">
    <form action="{{route('store-dokumentasi')}}" method="POST" enctype="multipart/form-data" class="dropzone" id="myDropzone">
        @csrf
        <div class="">
