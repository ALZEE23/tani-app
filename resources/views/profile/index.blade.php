...
<div class="container">
    ...
    <div class="select-wrapper">
        <a href="{{route('profile.informasi')}}"><button class="btn btn-secondary" style="width: 300px;">Informasi Pribadi</button></a><br><br>
        <a href="{{route('profile.sandi')}}"><button class="btn btn-secondary" style="width: 300px;">Sandi</button></a><br><br>
        <a href="{{route('budidaya')}}"><button class="btn btn-secondary" style="width: 300px;">Keluar</button></a><br><br>
    </div>
