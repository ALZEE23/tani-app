...
<div class="container">
    <h6 class="text-center">Pupuk</h6>
    <div class="image-wrapper">
        <img alt="image" src="{{ asset('images/menu-petani.png') }}" style="width: 100px; height:100px">
    </div>
    <div class="select-wrapper">
        <a href="{{route('padat')}}"><button class="btn btn-secondary" style="width: 300px;">Padat</button></a><br><br>
        <a href="{{route('cair')}}"><button class="btn btn-secondary" style="width: 300px;">Cair</button></a><br><br>
    </div>
