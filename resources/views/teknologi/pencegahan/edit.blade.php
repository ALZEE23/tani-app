...
<div class="container">
    <div class="row">
        <form action="{{ route('pencegahan.update', $pencegahan->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT') <!-- Gunakan method PUT untuk update -->

            <label for="judul">Judul:</label>
            <input type="text" name="judul" id="judul" value="{{ $pencegahan->judul }}" required>
