...
<div class="container has-pagehead is-pagetitle">
    <div class="section">
        <h5 class="pagetitle">Tambah Pestisida</h5>
    </div>
</div>
<div class="container">
    <form action="{{route('pestisida.import.storeexel')}}" method="POST" enctype="multipart/form-data">
        @csrf



        Import Excel
        <input type="file" name="pestisida" class="form-file">
